# Let's use our knowledge of using multiple parameters to create a function that splits a Doober fare between several users.

def split_fare(fare, passengers, feature_cost):

    share = fare / passengers
    print(
        f"Splitting the ${fare_cost} fare between {passengers} passengers...")
